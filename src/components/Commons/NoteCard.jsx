...
import { NOTE_CARD_BUTTON, MORE_OPTION_MENU } from "@/src/utils/Constants";
import IconButton from "./IconButton";
import Dropdown from "./Dropdown";
import ColorPicker from "./ColorPicker";
import { iconMap } from "@/src/utils/Icon";

const NoteCard = ({ note, onAction, onColorChange, buttons = NOTE_CARD_BUTTON }) => {
  ...
  const bgColor = note.colorClass || "bg-white";
